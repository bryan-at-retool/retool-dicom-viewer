...
//    console.log('handleOpenImage - this.dicomViewersRefs: ', this.dicomViewersRefs)
  ...
  componentDidMount() {
    ...
    window.scrollTo(0, 0)
    if (this.props.model && this.props.model.url && this.props.model.url.length) {
      this.dicomViewersRefs[this.props.activeDcmIndex].runTool('openurl', this.props.model.url)
    }
  }
